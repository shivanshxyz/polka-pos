import {
  getSyncProvider
} from "./chunk-NUCDN3S3.js";
import "./chunk-2TUXWMP5.js";

// node_modules/.pnpm/@polkadot-api+ws-provider@0.4.0/node_modules/@polkadot-api/ws-provider/dist/web/esm/types.mjs
var WsEvent = ((WsEvent2) => {
...
// node_modules/.pnpm/@polkadot-api+ws-provider@0.4.0/node_modules/@polkadot-api/ws-provider/dist/web/esm/follow-enhancer.mjs
var methods = {};
  ...
  const result = (onMsg) => {
    const { send, disconnect } = base((fromProvider) => {
      ...
      if ("id" in parsed) {
        ...
        if ((result2 == null ? void 0 : result2.event) === "stop") {
...
// node_modules/.pnpm/@polkadot-api+ws-provider@0.4.0/node_modules/@polkadot-api/ws-provider/dist/web/esm/ws-provider.mjs
var timeoutError = {
  type: WsEvent.ERROR,
  event: { type: "timeout" }
};
...
var getInternalWsProvider = (WebsocketClass) => {
  return (...args) => {
    let endpoints = [];
...
// node_modules/.pnpm/@polkadot-api+ws-provider@0.4.0/node_modules/@polkadot-api/ws-provider/dist/web/esm/web.mjs
var getWsProvider = getInternalWsProvider(WebSocket);
export {
  WsEvent,
  getWsProvider
};
//# sourceMappingURL=polkadot-api_ws-provider_web.js.map
