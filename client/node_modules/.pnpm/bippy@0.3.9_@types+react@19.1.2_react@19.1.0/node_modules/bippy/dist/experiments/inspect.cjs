...
var chunkBT7NXVMI_cjs = require('../chunk-BT7NXVMI.cjs');
...
var RawInspector = React14.forwardRef(
  ({ enabled = true, dangerouslyRunInProduction = false }, ref) => {
    ...
    React14.useEffect(() => {
      (async () => {
        if (!element) return;
        const fiber = chunkHIA3K5FI_cjs.getFiberFromHostInstance(element);
        if (!fiber) return;
        const latestFiber = chunkHIA3K5FI_cjs.getLatestFiber(fiber);
        const source = await chunkBT7NXVMI_cjs.getFiberSource(latestFiber);
    ...
    React14.useEffect(() => {
      const handleMouseMove = (event) => {
        const isActive2 = chunkHIA3K5FI_cjs.isInstrumentationActive() || chunkHIA3K5FI_cjs.hasRDTHook();
        if (!isActive2) {
          setIsActive(false);
          return;
        }
        if (!dangerouslyRunInProduction) {
          ...
          for (const renderer of rdtHook.renderers.values()) {
            const buildType = chunkHIA3K5FI_cjs.detectReactBuildType(renderer);
    ...
    return /* @__PURE__ */ React14__default.default.createElement(React14__default.default.Fragment, null, /* @__PURE__ */ React14__default.default.createElement(
      ...
      /* @__PURE__ */ React14__default.default.createElement(
        ...
        /* @__PURE__ */ React14__default.default.createElement(
          ...
          `<${chunkHIA3K5FI_cjs.getDisplayName(currentFiber.type) || "unknown"}>`
        ),
        /* @__PURE__ */ React14__default.default.createElement(
          "div",
          {
